 ...
 */
 exports.images = [
    ...
    { name: 'ios-ipad-2x-landscape.png',   width: 2048, height: 1536, pixelRatio:2.0  },
    { name: 'ios-ipad-2x-portrait.png',    width: 1536, height: 2048, pixelRatio:2.0  },
    { name: 'ios-iphone5-portrait.png',    width: 640,  height: 1136, pixelRatio:2.0  },
    { name: 'ios-iphone5-landscape.png',   width: 1136,  height: 640, pixelRatio:2.0  },
    { name: 'ios-iphone6-portrait.png',    width: 750,  height: 1334, pixelRatio:2.0  },
    { name: 'ios-iphone6-landscape.png',   width: 1334, height: 750, pixelRatio:2.0  },
    { name: 'ios-iphone6+-portrait.png',   width: 1242, height: 2208, pixelRatio:3.0  },
    { name: 'ios-iphone6+-landscape.png',  width: 2208, height: 1242, pixelRatio:3.0  },
